...
class UtmKtTest {
    ...
    fun UtmMtmTests() {
        ...
        assertEquals("IBM #01 LL->MGRS",           "31N AA 66021 00000", LatLonDatum(  0.0000,    0.0000).toUtm().toMgrs().toString())
        assertEquals("IBM #02 LL->UTM",            "30 N 808084 14386", LatLonDatum(  0.1300,   -0.2324).toUtm().toString(0))
        assertEquals("IBM #02 LL->MGRS",           "30N ZF 08084 14385", LatLonDatum(  0.1300,   -0.2324).toUtm().toMgrs().toString())
        assertEquals("IBM #03 LL->UTM",            "34 S 683474 4942631", LatLonDatum(-45.6456,   23.3545).toUtm().toString(0))
        assertEquals("IBM #03 LL->MGRS",           "34G FQ 83473 42631", LatLonDatum(-45.6456,   23.3545).toUtm().toMgrs().toString())
        assertEquals("IBM #04 LL->UTM",            "25 S 404859 8588691", LatLonDatum(-12.7650,  -33.8765).toUtm().toString(0))
        assertEquals("IBM #04 LL->MGRS",           "25L DF 04859 88691", LatLonDatum(-12.7650,  -33.8765).toUtm().toMgrs().toString())
        assertEquals("IBM #09 LL->UTM",            "08 N 453580 2594273", LatLonDatum( 23.4578, -135.4545).toUtm().toString(0))
        assertEquals("IBM #09 LL->MGRS",           "08Q ML 53580 94272", LatLonDatum( 23.4578, -135.4545).toUtm().toMgrs().toString())
        assertEquals("IBM #10 LL->UTM",            "57 N 450794 8586116", LatLonDatum( 77.3450,  156.9876).toUtm().toString(0))
        assertEquals("IBM #10 LL->MGRS",           "57X VF 50793 86116", LatLonDatum( 77.3450,  156.9876).toUtm().toMgrs().toString())
